<form method="POST" action="{{url('/events/update')}}" enctype="multipart/form-data">
    @csrf
    ...
    <div>
        ...
        <input name="title" id="title" value="{{$event['title']}}" class="mt-2 p-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-semibold w-full h-10 flex items-center text-sm border-gray-300 rounded border" placeholder="John Doe" />
        <div class="mb-3">
            @error('title')
    ...
    <div>
        ...
        <textarea id="description" name="description" class="editor mt-2 p-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-semibold w-full h-auto flex items-center text-sm border-gray-300 rounded border">{!!$event['description']!!}</textarea>
        <div class="mb-3">
            @error('description')
                <span class="invalid-feedback text-red-500" role="alert">
                    <strong>{{ $message }}</strong>
    ...
    <div>
        ...
        <label class="w-1/2 mt-2 flex flex-col items-center px-4 py-6 bg-white text-indigo-600 rounded-lg shadow-lg tracking-wide uppercase border border-indigo-600 cursor-pointer">
            ...
            <input type='file' name="bg_image_path" class="flex justify-center" accept="image/*"
            />
        </label>
        <img 
        ...
        @else
            src=""
            alt=""
        @endif class="w-12 h-12"  id="event_img">
    </div>
    ...
    <div>
        ...
        value="{{$event['location_address']}}" id="location_address" class="p-2 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-semibold w-full h-10 flex items-center text-sm border-gray-300 rounded border" placeholder="The event center" />
        <div class="mb-3">
    ...
    <div>
        ...
        <input name="location_address_line_1"
        value="{{$event['location_address_line_1']}}"
         id="location_address_line_1" class="p-2 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-semibold w-full h-10 flex items-center text-sm border-gray-300 rounded border" placeholder="2, Newton Street" />
        <div class="mb-3">
    ...
    <div>
        ...
        <input name="location_address_line_2"
        value="{{$event['location_address_line_2']}}" id="location_address_line_2" class="p-2 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-semibold w-full h-10 flex items-center text-sm border-gray-300 rounded border" placeholder="Abuja Nigeria" />
        <div class="mb-3">
    ...
    <div class="w-full flex space-x-4 justify-start flex-row">
        <div class="flex flex-col w-full md:w-1/3">
            ...
            value="{{$event['location_state']}}"
            id="location_state" class="p-2 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-semibold w-full h-10 flex items-center text-sm border-gray-300 rounded border" placeholder="Abuja">
            <div class="mb-3">
        ...
        <div class="flex flex-col w-full md:w-1/3">
            ...
            <input type="text" id="location_post_code"
            value="{{$event['location_post_code']}}" name="location_post_code" class="mt-2 p-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-semibold w-full h-10 flex items-center text-sm border-gray-300 rounded border" placeholder="901101">
            <div class="mb-3">
