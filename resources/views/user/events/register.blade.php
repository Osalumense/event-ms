                                                                    ...
                                                                    <div class="mb-5">
                                                                        ...
                                                                        <div class="flex items-center mt-4 h-3">
                                                                            <div class="w-2/3 flex justify-between h-2">	
                                                                                ...
                                                                                <div :class="{ 'bg-indigo-400': passwordStrengthText == 'Strong password' }" class="h-2 rounded-full w-1/3 bg-gray-300"></div>
                                                                            </div>
                                                                            <div x-text="passwordStrengthText" class="text-gray-500 font-medium text-sm ml-3 leading-none"></div>
                                                                        </div>
        
                                                                        <p class="mt-5 text-gray-600">Inspired from dribbble shot: Exploration for a password strength meter by <a href="https://dribbble.com/OvertonGraphics" class="text-indigo-500">Josh Overton</a>.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-section">
